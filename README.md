...
| GET    | `/api/admin/session`            | No     | Check dashboard session                     |
| GET    | `/api/admin/profile`            | Admin  | Get your profile and admin team directory   |
| PATCH  | `/api/admin/profile`            | Admin  | Update your profile                         |
...
| PATCH  | `/api/events/:id/leads/:leadId` | Admin  | Update a lead (signed-in dashboard only)    |
| DELETE | `/api/events/:id/leads`         | Admin  | Delete multiple leads (body: `{ leadIds }`) |
